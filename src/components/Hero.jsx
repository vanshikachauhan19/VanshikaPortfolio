    ...
    return (
        <section className="min-h-screen flex items-center justify-center pt-20 relative overflow-hidden bg-navy-900 selection:bg-cyan-400/30">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between relative z-10 w-full">
                ...
                {/* Profile Photo */}
                <div className="order-1 md:order-2 mb-8 md:mb-0 flex justify-center md:justify-end flex-1">
                    <img
                        src={`${import.meta.env.BASE_URL}images/vanshika.jpg`}
                        alt="Profile"
                        className="rounded-full object-cover shadow-xl border-4 border-white w-52 h-52 md:w-72 md:h-72"
                    />
                </div>
            </div>
        </section>
